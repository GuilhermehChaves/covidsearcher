...
class Route {
  ...
  initRoutes() {
    ...
    this.router.get(
      "/v1/countries/where/:field/smaller/:value",
      Country.smallerThan
    );
    this.router.get(
      "/v1/countries/where/:field/greater/:value",
      Country.greaterThan
    );
    this.router.get(
      "/v1/countries/:country/where/:field/smaller/:value",
      Country.casesSmallerByTime
    );
    this.router.get(
    ...
    this.router.get(
      "/v1/world/total/time/where/:field/smaller/:value",
      World.casesSmaller
    );
    this.router.get(
      "/v1/world/total/time/where/:field/greater/:value",
      World.casesGreater
    );
  }
}
